        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative isolate overflow-hidden rounded-2xl min-h-[320px] flex flex-col justify-end shadow-xs group">
            ...
            <div className="relative z-10 p-6 sm:p-7 space-y-3">
              <span className="inline-block text-xs font-bold uppercase tracking-wider text-[#DDF0E4] bg-[#3F7A59]/80 backdrop-blur-sm px-2.5 py-1 rounded-md">
                Daily Freshness
              </span>
              <h3 className="font-heading text-xl sm:text-2xl font-bold text-white leading-snug">
                We sell fresh dairy, daily
              </h3>
              <p className="text-sm text-[#EDE6DF] leading-relaxed max-w-sm">
              ...
              <a
                ...
                href="#products"
                className="inline-flex items-center gap-2 text-sm font-semibold text-white hover:text-[#E8A588] group/link transition-colors pt-1"
              >
          ...
          <div className="relative isolate overflow-hidden rounded-2xl min-h-[320px] flex flex-col justify-end shadow-xs group">
            ...
            <div className="relative z-10 p-6 sm:p-7 space-y-3">
              <div className="flex items-center gap-2">
                <span className="inline-block text-xs font-bold uppercase tracking-wider text-[#FBEFEA] bg-[#B85D38]/80 backdrop-blur-sm px-2.5 py-1 rounded-md">
                  Counter Pickup
                </span>
                <span className="text-xs text-[#EDE6DF] flex items-center gap-1 font-mono">
                  <Clock className="w-3 h-3 text-[#E8A588]" />
                  Save time
                </span>
              </div>
              <h3 className="font-heading text-xl sm:text-2xl font-bold text-white leading-snug">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#3F7A59] hover:bg-[#2F5C43] text-white text-sm font-semibold shadow-xs transition-colors mt-1"
              >
